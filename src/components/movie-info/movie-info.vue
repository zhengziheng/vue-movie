  ...
  <div class="movie-info">
    <div class="overall">
      <div class="desc">
        ...
        <span class="duration">片场:{{durations}}</span>
      </div>
      <div class="rank">
    ...
    <div class="operate">
      ...
      >
        <img src="./1.jpg" v-show="hasWatched" width="25" height="25">
        {{watchedText}}
      </div>
    </div>
    <div class="summary">
    ...
    <scroll class="casts" :scrollX="this.scrollX" :eventPassthrough="this.eventPassthrough" ref="scroll">
      <div class="casts-content" ref="content">
        ...
        <div class="cast-item" v-for="item in allCasts" :key="item.id"  @click="selectCelebrity(item.id,$event)">
...
props:{
  ...
  methods: {
    ...
    saveWatchedMovie(){
      ...
      if(index>-1){
        this.hasWatches = true
        this.watchesText = '已看过'
      }else{
